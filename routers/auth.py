...
async def register_user(request: Request, email: str = Form(...), username: str = Form(...), company: str = Form(...),
...
async def login(request: Request, db: Session = Depends(get_db)):
    try:
        ...
        response = RedirectResponse(url="/sensors", status_code=status.HTTP_302_FOUND)
